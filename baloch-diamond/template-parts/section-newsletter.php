...
$nl_btn_text    = get_theme_mod( 'bd_newsletter_btn_text', esc_html__( 'Subscribe', 'baloch-diamond' ) );
$nl_show_title  = get_theme_mod( 'bd_newsletter_show_title', true );
$nl_show_desc   = get_theme_mod( 'bd_newsletter_show_desc', true );
?>
...
<section class="newsletter-section" id="newsletter">
    ...
    <div class="newsletter-inner">
        ...
        <form class="newsletter-form" id="newsletterForm">
            <?php wp_nonce_field( 'bd_nonce', 'bd_newsletter_nonce', false ); ?>
